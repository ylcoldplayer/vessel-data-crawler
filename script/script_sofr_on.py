...
def get_sofr_on_data():
    url = 'https://www.chathamfinancial.com/technology/us-market-rates'

    try:
        print("start scraping sofr over night website....")
        ...
        rates_table = soup.find(
            lambda tag: tag.name == 'h2' and 'Secured Overnight Financing Rate (SOFR)' in tag.text).parent.parent
        ...
        driver.quit()
        print("end scraping sofr over night website....")
